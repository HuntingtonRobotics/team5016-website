...
export const footerData = {
  ...
  footNote: `
    <img class="w-5 h-5 md:w-6 md:h-6 md:-mt-0.5 bg-cover mr-1.5 rtl:mr-0 rtl:ml-1.5 float-left rtl:float-right rounded-sm" src="https://www.astrothemes.dev/images/logo/logo.svg" alt="onWidget logo" loading="lazy"></img>
    Made from a template by <a class="text-blue-600 underline dark:text-muted" href="https://www.astrothemes.dev/theme/onwidget-astrowind/"> AstroWind</a> · All rights reserved.
  `,
};
